...
export const cases: TestCase[] = [
			...
			Children: [
				{
					...
					DeletedAt: "2021-03-01T00:00:00Z",
					Children: null,
				},
			],
		},
			...
			Children: [
				{
					...
					DeletedAt: new Date("2021-03-01T00:00:00Z"),
					Children: null,
				},
			],
		},
	...
	// --- TestOneofRequired ---
	{
		...
		input: { status: "active", statusImplicitRequired: "active" },
		success: true,
	},
	{
		...
		golden: "TestOneofRequired.golden",
		schema: "PayloadSchema",
		input: { status: "", statusImplicitRequired: "active" },
		success: false,
	},
	{
		...
		golden: "TestOneofRequired.golden",
		schema: "PayloadSchema",
		input: { status: "deleted", statusImplicitRequired: "active" },
		success: false,
	},
	{
	...
	// --- TestOmitZero ---
	{
		...
		input: {
			...
			Email: "a@b.com",
			Address: { City: "Paris" },
			AddressOmitEmpty: { City: "" },
			Inline: { X: 1 },
			CreatedAt: "2021-01-01T00:00:00Z",
			CreatedAtEmpty: "0001-01-01T00:00:00Z",
			RequiredAt: "2021-01-01T00:00:00Z",
		...
		output: {
			...
			Inline: { X: 1 },
			CreatedAt: new Date("2021-01-01T00:00:00Z"),
			CreatedAtEmpty: new Date("0001-01-01T00:00:00Z"),
			RequiredAt: new Date("2021-01-01T00:00:00Z"),
	...
	{
		name: "omitzero: accepts omitzero fields missing (including zero structs and times)",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
	...
	{
		name: "omitzero: rejects omitempty struct missing (omitempty never omits structs)",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
	...
	{
		name: "omitzero: rejects omitempty time missing (omitempty never omits time.Time)",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
	...
	{
		name: "omitzero: rejects omitzero time with validate required missing",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
	...
	{
		name: "omitzero: rejects null for omitzero struct",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
	...
	{
		name: "omitzero: rejects null for omitzero slice",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
	...
	{
		name: "omitzero: rejects missing fields named omitzero/omitempty",
		golden: "TestOmitZero.golden",
		schema: "PayloadSchema",
		input: {
			Name: "alice",
